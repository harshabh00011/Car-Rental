...
export declare class NzTrMeasureComponent implements AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTrMeasureComponent, "tr[nz-table-measure-row]", never, { "listOfMeasureColumn": { "alias": "listOfMeasureColumn"; "required": false; }; }, { "listOfAutoWidth": "listOfAutoWidth"; }, never, never, false, never>;
}
