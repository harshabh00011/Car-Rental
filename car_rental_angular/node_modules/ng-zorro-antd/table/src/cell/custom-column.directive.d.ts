...
export declare class NzCustomColumnDirective<T> implements OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzCustomColumnDirective<any>, "td[nzCellControl],th[nzCellControl]", never, { "nzCellControl": { "alias": "nzCellControl"; "required": false; }; }, {}, never, never, false, never>;
}
