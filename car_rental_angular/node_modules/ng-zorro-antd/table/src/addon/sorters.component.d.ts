...
export declare class NzTableSortersComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTableSortersComponent, "nz-table-sorters", never, { "sortDirections": { "alias": "sortDirections"; "required": false; }; "sortOrder": { "alias": "sortOrder"; "required": false; }; "contentTemplate": { "alias": "contentTemplate"; "required": false; }; }, {}, never, never, false, never>;
}
