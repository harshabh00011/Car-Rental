...
export declare class NzFilterTriggerComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzFilterTriggerComponent, "nz-filter-trigger", ["nzFilterTrigger"], { "nzActive": { "alias": "nzActive"; "required": false; }; "nzDropdownMenu": { "alias": "nzDropdownMenu"; "required": false; }; "nzVisible": { "alias": "nzVisible"; "required": false; }; "nzBackdrop": { "alias": "nzBackdrop"; "required": false; }; }, { "nzVisibleChange": "nzVisibleChange"; }, never, ["*"], false, never>;
}
