...
export declare class NzBreadCrumbComponent implements OnInit, OnDestroy, NzBreadcrumb {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzBreadCrumbComponent, "nz-breadcrumb", ["nzBreadcrumb"], { "nzAutoGenerate": { "alias": "nzAutoGenerate"; "required": false; }; "nzSeparator": { "alias": "nzSeparator"; "required": false; }; "nzRouteLabel": { "alias": "nzRouteLabel"; "required": false; }; "nzRouteLabelFn": { "alias": "nzRouteLabelFn"; "required": false; }; }, {}, never, ["*"], false, never>;
}
