...
export declare class NzAutosizeDirective implements AfterViewInit, OnDestroy, DoCheck {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzAutosizeDirective, "textarea[nzAutosize]", ["nzAutosize"], { "nzAutosize": { "alias": "nzAutosize"; "required": false; }; }, {}, never, never, false, never>;
}
