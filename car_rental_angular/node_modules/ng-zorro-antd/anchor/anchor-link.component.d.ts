...
export declare class NzAnchorLinkComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzAnchorLinkComponent, "nz-link", ["nzLink"], { "nzHref": { "alias": "nzHref"; "required": false; }; "nzTarget": { "alias": "nzTarget"; "required": false; }; "nzTitle": { "alias": "nzTitle"; "required": false; }; }, {}, ["nzTemplate"], ["*"], false, never>;
}
