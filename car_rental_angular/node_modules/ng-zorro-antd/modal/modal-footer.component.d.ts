...
export declare class NzModalFooterComponent implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzModalFooterComponent, "div[nz-modal-footer]", ["NzModalFooterBuiltin"], { "modalRef": { "alias": "modalRef"; "required": false; }; }, { "cancelTriggered": "cancelTriggered"; "okTriggered": "okTriggered"; }, never, never, false, never>;
}
