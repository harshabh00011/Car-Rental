...
export declare class NzAutocompleteOptionComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzAutocompleteOptionComponent, "nz-auto-option", ["nzAutoOption"], { "nzValue": { "alias": "nzValue"; "required": false; }; "nzLabel": { "alias": "nzLabel"; "required": false; }; "nzDisabled": { "alias": "nzDisabled"; "required": false; }; }, { "selectionChange": "selectionChange"; "mouseEntered": "mouseEntered"; }, never, ["*"], false, never>;
}
