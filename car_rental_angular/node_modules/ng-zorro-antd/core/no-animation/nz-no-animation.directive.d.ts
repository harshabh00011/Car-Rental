...
export declare class NzNoAnimationDirective implements OnChanges, AfterViewInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzNoAnimationDirective, "[nzNoAnimation]", ["nzNoAnimation"], { "nzNoAnimation": { "alias": "nzNoAnimation"; "required": false; }; }, {}, never, never, false, never>;
}
