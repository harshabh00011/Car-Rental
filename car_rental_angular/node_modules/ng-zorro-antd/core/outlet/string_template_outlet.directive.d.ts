...
export declare class NzStringTemplateOutletDirective<_T = unknown> implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzStringTemplateOutletDirective<any>, "[nzStringTemplateOutlet]", ["nzStringTemplateOutlet"], { "nzStringTemplateOutletContext": { "alias": "nzStringTemplateOutletContext"; "required": false; }; "nzStringTemplateOutlet": { "alias": "nzStringTemplateOutlet"; "required": false; }; }, {}, never, never, false, never>;
}
