...
export declare class NzTransitionPatchDirective implements AfterViewInit, OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzTransitionPatchDirective, "[nz-button], nz-button-group, [nz-icon], [nz-menu-item], [nz-submenu], nz-select-top-control, nz-select-placeholder, nz-input-group", never, { "hidden": { "alias": "hidden"; "required": false; }; }, {}, never, never, false, never>;
}
