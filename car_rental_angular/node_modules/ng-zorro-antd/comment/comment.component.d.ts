...
export declare class NzCommentComponent implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzCommentComponent, "nz-comment", ["nzComment"], { "nzAuthor": { "alias": "nzAuthor"; "required": false; }; "nzDatetime": { "alias": "nzDatetime"; "required": false; }; }, {}, ["actions"], ["nz-avatar[nz-comment-avatar]", "nz-comment-content", "*"], false, never>;
}
