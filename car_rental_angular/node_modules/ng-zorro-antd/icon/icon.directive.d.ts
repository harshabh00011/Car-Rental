...
export declare class NzIconDirective extends IconDirective implements OnInit, OnChanges, AfterContentChecked, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzIconDirective, "[nz-icon]", ["nzIcon"], { "nzSpin": { "alias": "nzSpin"; "required": false; }; "nzRotate": { "alias": "nzRotate"; "required": false; }; "nzType": { "alias": "nzType"; "required": false; }; "nzTheme": { "alias": "nzTheme"; "required": false; }; "nzTwotoneColor": { "alias": "nzTwotoneColor"; "required": false; }; "nzIconfont": { "alias": "nzIconfont"; "required": false; }; }, {}, never, never, false, never>;
}
