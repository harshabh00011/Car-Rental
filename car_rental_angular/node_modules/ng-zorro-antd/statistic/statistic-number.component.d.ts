...
export declare class NzStatisticNumberComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzStatisticNumberComponent, "nz-statistic-number", ["nzStatisticNumber"], { "nzValue": { "alias": "nzValue"; "required": false; }; "nzValueTemplate": { "alias": "nzValueTemplate"; "required": false; }; }, {}, never, never, false, never>;
}
