...
export declare class NzCountdownComponent extends NzStatisticComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzCountdownComponent, "nz-countdown", ["nzCountdown"], { "nzFormat": { "alias": "nzFormat"; "required": false; }; }, { "nzCountdownFinish": "nzCountdownFinish"; }, never, never, false, never>;
}
