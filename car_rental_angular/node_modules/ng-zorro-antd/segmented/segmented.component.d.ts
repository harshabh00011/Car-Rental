...
export declare class NzSegmentedComponent implements OnChanges, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzSegmentedComponent, "nz-segmented", ["nzSegmented"], { "nzBlock": { "alias": "nzBlock"; "required": false; }; "nzDisabled": { "alias": "nzDisabled"; "required": false; }; "nzOptions": { "alias": "nzOptions"; "required": false; }; "nzSize": { "alias": "nzSize"; "required": false; }; "nzLabelTemplate": { "alias": "nzLabelTemplate"; "required": false; }; }, { "nzValueChange": "nzValueChange"; }, never, never, false, never>;
}
