...
export declare class NzTagComponent implements OnChanges, OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTagComponent, "nz-tag", ["nzTag"], { "nzMode": { "alias": "nzMode"; "required": false; }; "nzColor": { "alias": "nzColor"; "required": false; }; "nzChecked": { "alias": "nzChecked"; "required": false; }; }, { "nzOnClose": "nzOnClose"; "nzCheckedChange": "nzCheckedChange"; }, never, ["*"], false, never>;
}
