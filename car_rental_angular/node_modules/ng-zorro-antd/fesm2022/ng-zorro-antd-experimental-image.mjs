...
class NzImageModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.2.10", ngImport: i0, type: NzImageModule, declarations: [NzImageViewComponent], imports: [BidiModule,
            OverlayModule,
            PortalModule,
            DragDropModule,
            CommonModule,
    ...
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.2.10", ngImport: i0, type: NzImageModule, imports: [BidiModule,
            OverlayModule,
            PortalModule,
            DragDropModule,
            CommonModule,
